...
const courses = {
  ...
  "contents-programming": {
    ...
    kicker: "Python / Google Colab / Data art",
    title: "Contents Programming Practice",
    lead: "데이터와 알고리즘을 창작의 재료로 삼아 생성 이미지, 데이터 포스터, 텍스트와 소리의 시각화를 제작하는 Python 기반 콘텐츠 프로그래밍 수업입니다.",
    kind: "Creative Python course",
    term: "Fall 2026",
    image: "assets/python-data-art.svg",
    imageWidth: 1200,
    imageHeight: 760,
    shareImage: TEACHING_SHARE_IMAGES["contents-programming"],
    sectionNote: "주 3시간, 16주 과정의 이론과 제작 실습입니다.",
  },
